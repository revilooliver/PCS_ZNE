...
#SBATCH --job-name=8-qubit_h2o_clifford_homogeneous  ## When you run squeue -u NETID this is how you can identify the job

python --version
python 8-qubit_h2o_clifford_homogeneous.py